...
public enum NFCPassportReaderError: Error {
    ...
    //Switched access modifier to public
    public var value: String {
        switch self {
            case .ResponseError(_, let sw1, let sw2):
                return binToHexRep([UInt8](arrayLiteral: sw1,sw2))
            ...
            case .TagConnectionLost: return "Tag connection lost"
...
public enum NFCPassportReaderError: Error {
    ...
    public var value: String {
        switch self {
        case .ResponseError(_, let sw1, let sw2): return binToHexRep([UInt8](arrayLiteral: sw1,sw2))
            case .InvalidResponse: return "InvalidResponse"
            case .UnexpectedError: return "UnexpectedError"
            case .NFCNotSupported: return "NFCNotSupported"
            case .NoConnectedTag: return "NoConnectedTag"
            ...
            case .InvalidHashAlgorithmSpecified: return "InvalidHashAlgorithmSpecified"
            case .TagConnectionLost: return "Tag connection lost"
            case .InvalidDataPassed(let reason) : return "Invalid data passed"
            case .NotYetSupported(let reason) : return "Not yet supported"
        }
    }
}
